<?php /* Smarty version Smarty-3.1.21, created on 2020-11-30 11:01:39
         compiled from "C:\xampp\htdocs\cscart\design\backend\templates\views\companies\manage.tpl" */ ?>
<?php /*%%SmartyHeaderCode:8945521405fc4a6e3d025f1-26637585%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '8945521405fc4a6e3d025f1-26637585',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5fc4a6e3e8dbc3_18445713',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5fc4a6e3e8dbc3_18445713')) {function content_5fc4a6e3e8dbc3_18445713($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include 'C:/xampp/htdocs/cscart/app/functions/smarty_plugins\\block.hook.php';
...
">&nbsp;<span><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['company']->value['company_id'], ENT_QUOTES, 'UTF-8');?>
        ...
        <td width="25%" class="row-status" data-th="<?php echo $_smarty_tpl->__("name");?>
"><a href="<?php echo htmlspecialchars(fn_url("companies.update?company_id=".((string)$_smarty_tpl->tpl_vars['company']->value['company_id'])), ENT_QUOTES, 'UTF-8');?>
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['company']->value['company'], ENT_QUOTES, 'UTF-8');?>
</a></td>
        <?php if (fn_allowed_for("MULTIVENDOR")) {?>
            <td width="25%" class="row-status" data-th="<?php echo $_smarty_tpl->__("email");?>
...
--></td>
        <?php }?>
        <td width="20%" class="row-status" data-th="<?php echo $_smarty_tpl->__("registered");?>
...
">
        ...
        <?php } else { ?>
            <td width="13%" class="row-status" data-th="<?php echo $_smarty_tpl->__("stores_status");?>
">
